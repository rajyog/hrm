    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Job Stage')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('jobstage.create') }}" class="btn btn-xs btn-white btn-icon-only width-auto" data-ajax-popup="true" data-title="{{__('Create New Job Stage')}}">
                            ...
                            <li class="list-group-item" data-id="{{$stage->id}}">
                                ...
                                @can('Edit Job Stage')
                                    <span class="float-right">
                                        <a href="#" data-url="{{ route('jobstage.edit',$stage->id) }}" data-ajax-popup="true" data-title="{{__('Edit Job Stage')}}" class="action-item" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
                                        ...
                                        @can('Delete Job Stage')
                                            ...
                                            {!! Form::open(['method' => 'DELETE', 'route' => ['jobstage.destroy', $stage->id],'id'=>'delete-form-'.$stage->id]) !!}
                                            {!! Form::close() !!}
                                        </span>
                                @endcan
                            </li>
