        ...
        <div class="all-button-box row d-flex justify-content-end">
            @if(\Auth::user()->type=='super admin')
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                    <a href="#" data-url="{{ route('users.create') }}" data-size="xl" data-ajax-popup="true" data-title="{{__('Create New Company')}}" class="btn btn-xs btn-white btn-icon-only width-auto">
                        <i class="fa fa-plus"></i> {{__('Create')}}
                    </a>
                </div>
            @else
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                    <a href="#" data-url="{{ route('users.create') }}" data-size="xl" data-ajax-popup="true" data-title="{{__('Create New User')}}" class="btn btn-xs btn-white btn-icon-only width-auto">
                        <i class="fa fa-plus"></i> {{__('Create')}}
                    </a>
                </div>
            @endif
                        ...
                        <div class="edit-profile user-text">
                            <div class="dropdown action-item">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    @can('Edit User')
                                        <a href="#" data-url="{{ route('users.edit',$user->id) }}" class="dropdown-item text-sm" data-ajax-popup="true" data-toggle="tooltip" data-title="{{__('Edit User')}}" data-original-title="{{ __('Edit User') }}">{{__('Edit')}}</a>
                                    @endcan
                                    @can('Delete User')
